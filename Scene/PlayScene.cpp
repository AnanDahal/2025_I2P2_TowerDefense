...
void PlayScene::Update(float deltaTime) {
    ...
    // --- Danger indicator calculation (unchanged) ---
    ...
    // --- Timed Enemy spawn logic (from code 1) ---
    ticks += deltaTime * SpeedMult;  // accumulate time
    ...
    // --- Turret-preview and shovel-preview (unchanged) ---
    if (preview) {
